      ...
      <div className="Statistics-container">
        ...
        <Carousel>
          ...
          <div className="box-stat">
            ...
            <div className="box-stat">
              ...
              <div className="name-state"><p>Parkings in the app:</p></div>
              <div className="info-state"><h1>{Data?.length}</h1></div>
              </div>
            </div>
        </Carousel>
      </div>
        <div className="web-stat">
          <div className="box-stat-web">
              <div className="icon-state-web"><img width="50" height="50" src="data:image/png;base64," alt="walking" /></div>
              <div className="name-state-web"><p>Available now:</p></div>
              <div className="info-state-web"><p id="data-p">{activeParking?.length}</p></div>
            </div>
            <div className="box-stat-web">
              <div className="icon-state-web"><img width="50" height="50" src="https://img.icons8.com/fluency-systems-regular/48/FFFFFF/shekel.png" alt="parking" /></div>
              <div className="name-state-web"><p>Your profit</p></div>
              <div className="info-state-web"><p id="data-p">{parseFloat(userData?.totalEarn.toFixed(2))}₪</p></div>
            </div>
            <div className="box-stat-web">
              <div className="icon-state-web"><img width="48" height="48" src="https://img.icons8.com/fluency-systems-regular/48/FFFFFF/shekel.png" alt="shekel"/></div>
              <div className="name-state-web"><p>Average P/H:</p></div>
              <div className="info-state-web"><p id="data-p">{avg}₪</p></div>
            </div>
            <div className="box-stat-web">
              <div className="icon-state-web"><img width="50" height="50" src="https://img.icons8.com/fluency-systems-regular/48/FFFFFF/parking.png" alt="parking" /></div>
              <div className="name-state-web"><p>Parkings in the app:</p></div>
              <div className="info-state-web"><p id="data-p">{Data?.length}</p></div>
              </div>
        </div>
      <br />
    </div>
