          ...
          <div className="screen__content">
            ...
            <div className="login__field">
              <img
                ...
                width="25"
                height="25"
                src="https://img.icons8.com/ios-glyphs/30/7875b5/guest-male.png"
                alt="guest-male"
              />
              <input
                type="text"
            ...
            <div className="login__field">
              <img
                ...
                width="25"
                height="25"
                src="https://img.icons8.com/android/24/7875b5/lock.png"
                alt="lock"
              />
              <input
                type="password"
            ...
            <div>
              <Link className="link-to-register" to={"/Verifymail"}>
                Forgot password?
              </Link>
            </div>
          </div>
